<template>
  <div class="app-container">
            ...
            <el-row :gutter="28">
                <el-col :span="24">
                  <el-form :model="searchForm" :inline="true" class="demo-form-inline" label-width="68px">
                    ...
                    <el-form-item>
                        <el-button plain type="warning" size="mini" icon="el-icon-plus" @click="add">新增</el-button>
                    </el-form-item>
                  </el-form>
                </el-col>
            </el-row>
            <el-table :data="tableData.row" stripe style="margin-top:5px">
                ...
                <el-table-column label="指标编码" prop="zbbm" width="100"></el-table-column>
                <el-table-column label="指标名称" prop="zbmc" width="100">
                    <template slot-scope="scope">
                        <el-link type="primary" @click="see(scope.row.pkid)">{{scope.row.zbmc}}</el-link>
                    </template>
                </el-table-column>
                <el-table-column label="创建时间" prop="cjsj" width="115"></el-table-column>
                <el-table-column label="创建人员" prop="cjry"></el-table-column>
                <el-table-column label="修改时间" prop="xgsj" width="115"></el-table-column>
                <el-table-column label="修改人员" prop="xgry"></el-table-column>
                <el-table-column label="操作" width="170">
                    <template slot-scope="scope">
                        <el-button plain type="success" size="mini" icon="el-icon-edit" @click="update(scope.row.pkid)">修改</el-button>
                        <el-button plain type="danger" size="mini" icon="el-icon-delete" @click="del(scope.row.pkid)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <pagination
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogTableVisible" :before-close="closeDialog">
        <el-form ref="dialogForm" :disabled="disabled" :model="dialogForm" label-width="80px">
            ...
            <el-form-item label="业务描述" prop="ywms" v-show="dialogForm.zblx == 1">
                <el-input v-model="dialogForm.ywms"></el-input>
            </el-form-item>
            <el-form-item label="计算公式" prop="jsgs" v-show="dialogForm.zblx == 1">
                <el-input v-model="dialogForm.jsgs"></el-input>
            </el-form-item>
            <el-form-item label="更新周期" prop="gxzq" v-show="dialogForm.zblx == 1">
...
<script>
import {getList, getTreeList, getInfo, addInfo} from '@/api/target/targetMenu'
export default {
  ...
  computed: {
    ...
    tableIndex: function() {
      return (this.searchForm.currentPage - 1) * this.searchForm.pageSize
    }
  },
  methods: {
    async getTreeList() {
    ...
    search(v) {
      ...
      getList(this.searchForm).then(({data}) => {
        this.tableData = data
      })
    },
    see(pkid) {
